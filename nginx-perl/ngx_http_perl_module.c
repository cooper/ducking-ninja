...
ngx_http_perl_run_requires(pTHX_ ngx_array_t *requires, ngx_log_t *log)
{
    ...
    ngx_log_error(NGX_LOG_NOTICE, log, 0, "ngx_http_perl_run_requires() called");

    if (requires == NGX_CONF_UNSET_PTR) {
        ngx_log_error(NGX_LOG_NOTICE, log, 0, "ngx_http_perl_run_requires() requires = NGX_CONF_UNSET_PTR");
        return NGX_OK;
    }
    ...
    ngx_log_error(NGX_LOG_NOTICE, log, 0, "ngx_http_perl_run_requires() returning OK");
